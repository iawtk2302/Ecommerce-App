                ...
                if (state is PaymentMethodsLoading) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (_, index) {
                      ...
                      final tempLst = paymentCards.where(
                          (element) => element.type == paymentMethod.code);
                          ...
                          return BlocBuilder<UserBloc, UserState>(
                            builder: (context, state) {
                              ...
                              if (state is UserLoaded) {
                                subTitle =
                                    "Balance: ${state.user.eWalletBalance.toPriceString()}";
                                balance = state.user.eWalletBalance;
                              }
                              return BlocBuilder<PlaceOrderBloc,
                                  PlaceOrderState>(
                                builder: (context, state) {
                                  final isEnabled = balance != null &&
                                      balance >= state.totalPrice!;
                            ...
                            builder: (context, state) {
                              return PaymentItemCard(
                                ...
                                onTap: thisPaymentInformation == null
                                    ? null
                                    : () => _onSelectPayment(
                                        paymentMethod: paymentMethodsResource[
                                            paymentMethod]!,
                                        paymentInformation:
                                            thisPaymentInformation),
                              );
